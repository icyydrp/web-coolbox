    ...
    <section class="nosotros-container">
        <div class="card center-card">
            <div class="container-nosotros">
                ...
                <p>Somos Coolbox, una tienda de tecnología líder en el mercado peruano. Fundada en 2005, nos especializamos en ofrecer productos de alta calidad, desde computadoras y teléfonos inteligentes hasta accesorios de gaming y componentes informáticos. Nuestra misión es proporcionar a nuestros clientes la mejor experiencia de compra, brindando productos innovadores y un servicio excepcional.</p>
            </div>
        </div>
        <div class="container-mision-vision">
            <div class="card mision">
                <h2>Nuestra Misión</h2>
                <p>En Coolbox, nos esforzamos por ser la primera opción para los entusiastas de la tecnología, ofreciendo una amplia gama de productos de alta calidad y un servicio al cliente excepcional.</p>
            </div>
            <div class="card vision">
                <h2>Nuestra Visión</h2>
                <p>Buscamos ser líderes en el mercado tecnológico peruano, superando las expectativas de nuestros clientes y contribuyendo al desarrollo tecnológico del país.</p>
            </div>
        </div>
    </section>
</main>
