<?php include('include/header.php'); ?>
        ...
        <!---------------------------->
        <!--Main - Tarjetas Graficas-->
        <!---------------------------->
    <main>
        <section class="tarjetasgraficas-venta">
            <div class="container-tarjetasgraficas">
                <!-- Tarjeta Grafica 1 -->
                <div class="card-tarjetasgraficas">
                    <div class="tarjetasgraficas-img">
                        <img class="img-tarjetasgraficas" src="img/tarjeta-promocion.jpg" alt="Tarjeta Grafica">
                    </div>
                    <div class="tarjetasgraficas-info">
                        <h5>Tarjetas Graficas</h5>
                        <h3>Tarjeta Grafica NVIDIA RTX3060 MSI</h3>
                        <h4>S/1,599</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-tarjetasgraficas">
                    <div class="tarjetasgraficas-img">
                        <img class="img-tarjetasgraficas" src="img/tg2.jpg" alt="Tarjeta Grafica ">
                    </div>
                    <div class="tarjetasgraficas-info">
                        <h5>Tarjetas Graficas</h5>
                        <h3>TARJETA DE VIDEO PALIT RTX 3070 GAMINGPRO 8GB GDDR6</h3>
                        <h4>S/3,149</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-tarjetasgraficas">
                    <div class="tarjetasgraficas-img">
                        <img class="img-tarjetasgraficas" src="img/tg3.jpg" alt="Tarjeta Grafica ">
                    </div>
                    <div class="tarjetasgraficas-info">
                        <h5>Tarjetas Graficas</h5>
                        <h3>TARJETA DE VIDEO SAPPHIRE RX 7700 XT 12GB GDDR6</h3>
                        <h4>S/2,369</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-tarjetasgraficas">
                    <div class="tarjetasgraficas-img">
                        <img class="img-tarjetasgraficas" src="img/tg4.jpg" alt="Tarjeta Grafica ">
                    </div>
                    <div class="tarjetasgraficas-info">
                        <h5>Tarjetas Graficas</h5>
                        <h3>TARJETA DE VIDEO GIGABYTE RTX 4090 GAMING OC 24GB GDDR6X</h3>
                        <h4>S/8,429</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
