<?php include('include/header.php'); ?>
        ...
        <!--------------------------->
    <main>
        <section class="audifonos-venta">
            <div class="container-audifonos">
                <!-- Audifonos 1 -->
                <div class="card-audifonos">
                    <div class="audifonos-img">
                        <img class="img-audifonos" src="img/audifono-promocion.jpg" alt="audifonos ">
                    </div>
                    <div class="audifonos-info">
                        <h5>Audifonos</h5>
                        <h3>Audifono VSG</h3>
                        <h4>S/140.00</h4>
                ...
                <div class="card-audifonos">
                    <div class="audifonos-img">
                        <img class="img-audifonos" src="img/audifono2.jpg" alt="audifonos ">
                    </div>
                    <div class="audifonos-info">
                        <h5>Audifonos</h5>
                        <h3>Audifono Razer Blackshark V2</h3>
                        <h4>S/299.90</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-audifonos">
                    <div class="audifonos-img">
                        <img class="img-audifonos" src="img/audifono3.jpg" alt="audifonos ">
                    </div>
                    <div class="audifonos-info">
                        <h5>Audifonos</h5>
                        <h3>Audifonos Logitech G Pro X Wirelles</h3>
                        <h4>S/630.00</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-audifonos">
                    <div class="audifonos-img">
                        <img class="img-audifonos" src="img/audifono4.jpg" alt="audifonos ">
                    </div>
                    <div class="audifonos-info">
                        <h5>Audifonos</h5>
                        <h3>Audifonos Hyperx Cloud II Wirelles</h3>
                        <h4>S/500.00</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
