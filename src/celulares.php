<?php include('include/header.php'); ?>
        ...
        <!--------------------------->
    <main>
        <section class="Celular-venta">
            <div class="container-Celulares">
                <!-- Celular 1 -->
                <div class="card-celular">
                    <div class="celular-img">
                        <img class="img-celular" src="img/celular-promocion.jpg" alt="celular ">
                    </div>
                ...
                <div class="card-celular">
                    <div class="celular-img">
                        <img class="img-celular" src="img/celular2.jpg" alt="celular ">
                    </div>
                    <div class="celular-info">
                        <h5>Celulares</h5>
                        <h3>Samsung S21 5G</h3>
                        <h4>S/1,399</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <!-- Celular 3 -->
                <div class="card-celular">
                    <div class="computadora-img">
                        <img class="img-celular" src="img/celular3.jpg" alt="celular ">
                    </div>
                    <div class="celular-info">
                        <h5>Celulares</h5>
                        <h3>Xiaomi Redmi 10 2022 4GB+128GB</h3>
                        <h4>S/619.00</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
                ...
                <div class="card-celular">
                    <div class="computadora-img">
                        <img class="img-celular" src="img/celular4.jpg" alt="celular ">
                    </div>
                    <div class="celular-info">
                        <h5>Celulares</h5>
                        <h3>Samsung Galaxy S23 Ultra 5G 256 GB</h3>
                        <h4>S/3,549</h4>
                        <button class="Agregar_carrito">Agregar carrito</button>
                    </div>
                </div>
